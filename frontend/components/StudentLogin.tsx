...
export default function AuthModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-6 relative">
      ...
      <h2 className="text-center text-lg font-semibold mb-4">InternshipE</h2>
        ...
        <>
          ...
          <label className="block mb-2">
            ...
            <input
              type="text"
              placeholder="Нэр"
              className="w-full mt-1 p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-700"
            />
          </label>
          ...
          <label className="block mb-4">
            <span className="text-gray-700 text-sm">Голч</span>
            <input
              type="number"
              placeholder="4.0"
              className="w-full mt-1 p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-700"
          ...
          <label className="block mb-4">
            <span className="text-gray-700 text-sm">Ур чадвар</span>
            <textarea
          ...
          <Link href="/" className="w-full bg-blue-700 text-white py-3 px-2 rounded font-semibold mb-4 hover:bg-blue-500 transition">
            Бүртгүүлэх
          </Link>
        </>
      )}
